...
// Logging out of the application
    ...
    const forwardedReports =()=>{
        ...
        fetch(`https://ancient-citadel-22859.herokuapp.com/dashboard/home/forwarded/${user}`)
        .then(res => res.json())
        .then(result => {
            setReports(result)
    ...
    const pendingReports =()=>{
        ...
        fetch(`https://ancient-citadel-22859.herokuapp.com/dashboard/home/pending/${user}`)
        .then(res => res.json())
        .then(result => {
            setReports(result)
